...
INSERT INTO `market`.`products` (`name`, `description`, `price`, `categoria_idcategoria`) VALUES ('Smartphone', 'Smartphone Android', 799.99, 1);
INSERT INTO `market`.`products` (`name`, `description`, `price`, `categoria_idcategoria`) VALUES ('Camiseta', 'Camiseta 100% algodão', 29.99, 2);
INSERT INTO `market`.`products` (`name`, `description`, `price`, `categoria_idcategoria`) VALUES ('Maçã', 'Maçã orgânica', 0.99, 3);
